...
class Discriminator(nn.Module):
    ...
    def forward(self, x):
        x = self.master_controller(x)
        x = torch.sigmoid(self.fcIt seems like your code is almost correct, but it appears there are some issues with indentation and duplicated code. I’ve corrected the formatting and removed the redundant training loop. Here's the cleaned-up version:
